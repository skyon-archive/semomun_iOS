...
extension WorkbookGroupResultVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // 임시로직
        let info = PrivateTestResultInfoOfDB(id: 0, wid: 0, wgid: 0, sid: 0, uid: 0, title: "테스트 모의고사 1회차", subject: "화법과 작문", area: "국어 영역", totalTime: 3600, currentProblemCount: 10, totalProblemCount: 12, rank: 1, rawScore: 92, deviation: 128, percentile: 96, createdDate: Date(), updatedDate: Date())
